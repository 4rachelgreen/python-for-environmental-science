...
# x > xg
#
# meshgrid takes two 1-D arrays of X and Y coordinates and returns two X and Y
...
# Empty plot with 3 axes
ax = Axes3D(fig)

# rstride/cstride: row/column stride; step that allows you to skip rows/columns
# cmap: color map
