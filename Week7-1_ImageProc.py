...
plt.imshow(face)
plt.subplot(1,2,2)
plt.imshow(ascent, cmap='gray')     # Must specify a color ramp for grayscale images

# READING IMAGES
#   flatten option reduces to 1-band gray scale image
flor_rgb = ndi.imread('florence2.jpg')
flor_gray = ndi.imread('florence2.jpg', flatten = True)
...
flor_rgb.ndim   # number of dimensions (bands)
...
plt.imshow(flor_laplace, cmap = 'seismic')

# Sobel Edge detection
flor_sobel = ndi.sobel(flor_gray,mode='constant')
plt.imshow(flor_sobel)
