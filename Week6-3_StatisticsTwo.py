...
# Null hypothesis: There is no difference between the means of A and B
...
#   cubic = connects points with cubic function
#   quadratic = connects points with quadratic function
...
#%% 2D Interpolation using radial basis function
...
file_in = '/Users/Bryn/Documents/Bryn/17 Winter/Geography 59/GitHub/Dart_EnvGIS/Data/Olympia_Dec2015.csv'

olym_WX = pd.read_csv(file_in,parse_dates=[['Date', 'Time']])
...
plt.plot(olym_4HMean, label = '4H Mean')
plt.plot(olym_12HMean, label = '12H Mean')
plt.plot(olym_24HMean, label = '24H Mean')
plt.plot(olym_72HMean, label = '72H Mean')
plt.legend()
