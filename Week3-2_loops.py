...
# 1) Hit return 
#       Break lines at operators. Can either break every variable or at end of line.
...
# of iterations (anything that can be indexed)
#
#   FOR <iterator> in <iterable>:
#       do something for each value in the iterable variable

# The iterator is a temporary variable to store things in the iterable. 
# The name of the iterator should reflect the nature of the list.

# basic FOR loop: loop continues until the end of the list
...
#
# range(start,end,step) creates a temporary list of numbers based on the inputs
...
# Convert slope_percent to gradient and calculate drop over given distances
...
#
# In FOR/WHILE loops breaks are usually paired with an IF statement to activate the break
