...
#
# Figure: a blank container for plots
# Subplots: a way to organize multiple plots inside a figure
...
#   figure you have just created (as long as you keep the window open)
...
#   figures
# In general, it's better to use the plt.figure() function before any plot always.
...
#   plt.subplot(<# of rows>, <# of columns>, <plot #>)
#
...
#   that you have access to the individual graphs

# with individual graphs defined, you can plot and access the attributes through
#   dot notation for each graph
...
# Pcolor plot will color an array by the values in the array
ax2.pcolor(Z)
...
#       - you can also have the axes "span" multiple rows or columns
...
# MAC (Drag file/folder to console to display path)
os.chdir("/Users/Bryn/Documents/Bryn/17 Winter/Geography 59/GitHub/Dart_EnvGIS/Data/")
